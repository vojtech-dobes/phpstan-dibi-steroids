...
final class ConcatColumnNullableTest extends DatabaseSpecificTypeInferenceSharedBase
{

	private const Query = 'SELECT CONCAT(`notes`) `notes` FROM `books` LIMIT 1';
	...
	public function withPostgres(Dibi\Connection $dibi): void
	{
		...
		$expectedType = 'list<Dibi\Row<array{notes: string}>>';
